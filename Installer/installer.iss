...
#define MyAppVersion "4.1.0.3-alpha"
#define MyAppName "TiXL-v4.1.0.3-alpha"
...
Source: "..\.Defaults\Tests\*"; DestDir: "{userappdata}\TiXL\Tests"; Flags: ignoreversion recursesubdirs
